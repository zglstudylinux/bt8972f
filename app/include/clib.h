...
typedef char *(*f2str_func_t)(char *strbuf, double dval, uint precision, uint radix);
char *f2str_cb(char *strbuf, double dval, uint precision, uint radix);
void f2str_hook_init(f2str_func_t f2str);       //printf callback for float
