...
{
    memset((uint8_t *)&dnr_fre_cb, 0, sizeof(dnr_fre_cb_t));
	...
	dnr_fre_cb.denoiseBound		    = 10000;  //降噪量：20*log10(denoiseBound/32768) . 16384就相当于噪声降6db
	dnr_fre_cb.enr_nr_thr				= -50;//dB  门限：低于此门限为噪声
	...
	dnr_fre_cb.fs						= 48000;
	dnr_fre_cb.noise_init				= 3;

	dnr_fre_cb.noise_init_en			=0;
